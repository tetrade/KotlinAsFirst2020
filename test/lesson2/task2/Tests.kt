...
class Tests {
    ...
    fun circleInside() {
        ...
        assertFalse(circleInside(0.0, 2.220446049250313e-16, 0.30111008297503317, 0.1459683116429089, 0.32945672194606557, 0.37807494744013453))
    }
    ...
    fun brickPasses() {
        ...
        assertTrue(brickPasses(1, 2, 3, 2, 1))
    }
}